...
return [
    ...
    ['method' => 'GET', 'path' => '/admin/iadeler', 'handler' => ['Admin\\RefundController', 'index'], 'middleware' => [
        ['class' => AuthMiddleware::class],
        ['class' => RoleMiddleware::class, 'params' => ['roles' => ['admin', 'support']]],
    ]],
    ['method' => 'POST', 'path' => '/admin/iadeler/{id}/guncelle', 'handler' => ['Admin\\RefundController', 'update'], 'middleware' => [
        ['class' => AuthMiddleware::class],
        ['class' => RoleMiddleware::class, 'params' => ['roles' => ['admin', 'support']]],
    ]],
    ['method' => 'GET', 'path' => '/admin/cuzdanlar', 'handler' => ['Admin\\WalletAdminController', 'index'], 'middleware' => [
        ['class' => AuthMiddleware::class],
        ['class' => RoleMiddleware::class, 'params' => ['roles' => ['admin']]],
    ]],
    ['method' => 'POST', 'path' => '/admin/cuzdanlar/duzelt', 'handler' => ['Admin\\WalletAdminController', 'adjust'], 'middleware' => [
        ['class' => AuthMiddleware::class],
        ['class' => RoleMiddleware::class, 'params' => ['roles' => ['admin']]],
    ]],
    ['method' => 'GET', 'path' => '/admin/raporlar', 'handler' => ['Admin\\ReportController', 'index'], 'middleware' => [
        ['class' => AuthMiddleware::class],
        ['class' => RoleMiddleware::class, 'params' => ['roles' => ['admin', 'editor']]],
    ]],
