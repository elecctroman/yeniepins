...
return [
    ...
    ['method' => 'POST', 'path' => '/sepet/ekle', 'handler' => ['CartController', 'add']],
    ...
    ['method' => 'GET', 'path' => '/admin/urunler', 'handler' => ['AdminController', 'products'], 'middleware' => [
        ['class' => AuthMiddleware::class],
        ['class' => RoleMiddleware::class, 'params' => ['roles' => ['admin', 'editor']]],
    ]],
    ['method' => 'GET', 'path' => '/admin/stok', 'handler' => ['AdminController', 'stock'], 'middleware' => [
        ['class' => AuthMiddleware::class],
        ['class' => RoleMiddleware::class, 'params' => ['roles' => ['admin', 'editor', 'support']]],
    ]],
